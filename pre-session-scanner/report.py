...
SYSTEM_PROMPT = (
    ...
    "structured scan data. Write four parts. Be terse throughout — cut "
    "any sentence that doesn't add a number or a new fact. Target under "
    "220 words total; this is read in the seconds before a trading "
    "session, not studied.\n\n"
    ...
    "not the basis for this call. Name the 2-3 metrics driving the call. "
    "This is a heuristic read of the data provided, not a verified "
    "predictive signal with a track "
    "record — say that once, briefly, then give the call plainly without "
    "further hedging. 2-3 sentences, max.\n\n"
    "Do not give trading advice or tell the reader to buy, sell, or hold "
    "anything — describe the bias, not an instruction."
)
